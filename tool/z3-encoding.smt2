                    ...
                    (=> (and (RW_O o1 o2) (not (= o1 o2)) (not (= t1 t2)))
                        (or false
                            (exists ((r Bankaccount))
                                ...
                                (= (Bankaccount_Proj_b_id r) 1000)  true))) )))
...
(assert (! (exists ( (t1 O) (t2 O) (t3 O) (t4 O) (t5 O) (t6 O) (t7 O)) (and (not (= t1 t7)) (D t1 t2) (X t2 t3) (X t3 t4) (X t4 t5) (X t5 t6) (X t6 t7) (X t7 t1))) :named cycle))
