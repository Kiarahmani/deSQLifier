...
;Guarantees
;SER (New_order)
(assert (! (forall ((o1 O) (o2 O)) (=> (and (= (type (parent o2)) New_order)(ar o1 o2)) (vis o1 o2))) :named ser_New_order))(assert (! (forall ((o1 O) (o2 O) (o3 O)) (=> (and (= (type (parent o3)) New_order)(ar o1 o2)(vis o2 o3))(vis o1 o3))) :named ser2_New_order))
;RR (New_order)
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o2)) New_order)(vis o1 o2)(sibling o2 o3))(vis o1 o3))) :named rr_New_order))
;RC (New_order)
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o2)) New_order)(vis o1 o2)(sibling o1 o3))(vis o3 o2))) :named rc_New_order))
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o1)) New_order)(is_write o3))(and (ar o1 o2)(sibling o2 o3))(ar o1 o3))) :named rc2_New_order))
;SER (Payment)
(assert (! (forall ((o1 O) (o2 O)) (=> (and (= (type (parent o2)) Payment)(ar o1 o2)) (vis o1 o2))) :named ser_Payment))(assert (! (forall ((o1 O) (o2 O) (o3 O)) (=> (and (= (type (parent o3)) Payment)(ar o1 o2)(vis o2 o3))(vis o1 o3))) :named ser2_Payment))
;RR (Payment)
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o2)) Payment)(vis o1 o2)(sibling o2 o3))(vis o1 o3))) :named rr_Payment))
;RC (Payment)
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o2)) Payment)(vis o1 o2)(sibling o1 o3))(vis o3 o2))) :named rc_Payment))
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o1)) Payment)(is_write o3))(and (ar o1 o2)(sibling o2 o3))(ar o1 o3))) :named rc2_Payment))
;RR (Order_status)
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o2)) Order_status)(vis o1 o2)(sibling o2 o3))(vis o1 o3))) :named rr_Order_status))
;RC (Order_status)
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o2)) Order_status)(vis o1 o2)(sibling o1 o3))(vis o3 o2))) :named rc_Order_status))
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o1)) Order_status)(is_write o3))(and (ar o1 o2)(sibling o2 o3))(ar o1 o3))) :named rc2_Order_status))
;SER (Stock_level)
(assert (! (forall ((o1 O) (o2 O)) (=> (and (= (type (parent o2)) Stock_level)(ar o1 o2)) (vis o1 o2))) :named ser_Stock_level))(assert (! (forall ((o1 O) (o2 O) (o3 O)) (=> (and (= (type (parent o3)) Stock_level)(ar o1 o2)(vis o2 o3))(vis o1 o3))) :named ser2_Stock_level))
;RR (Stock_level)
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o2)) Stock_level)(vis o1 o2)(sibling o2 o3))(vis o1 o3))) :named rr_Stock_level))
;RC (Stock_level)
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o2)) Stock_level)(vis o1 o2)(sibling o1 o3))(vis o3 o2))) :named rc_Stock_level))
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o1)) Stock_level)(is_write o3))(and (ar o1 o2)(sibling o2 o3))(ar o1 o3))) :named rc2_Stock_level))
;SER (Delivery)
(assert (! (forall ((o1 O) (o2 O)) (=> (and (= (type (parent o2)) Delivery)(ar o1 o2)) (vis o1 o2))) :named ser_Delivery))(assert (! (forall ((o1 O) (o2 O) (o3 O)) (=> (and (= (type (parent o3)) Delivery)(ar o1 o2)(vis o2 o3))(vis o1 o3))) :named ser2_Delivery))
;RR (Delivery)
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o2)) Delivery)(vis o1 o2)(sibling o2 o3))(vis o1 o3))) :named rr_Delivery))
;RC (Delivery)
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o2)) Delivery)(vis o1 o2)(sibling o1 o3))(vis o3 o2))) :named rc_Delivery))
(assert (! (forall ((o1 O)(o2 O)(o3 O))(=> (and (= (type (parent o1)) Delivery)(is_write o3))(and (ar o1 o2)(sibling o2 o3))(ar o1 o3))) :named rc2_Delivery))
